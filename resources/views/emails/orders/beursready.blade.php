...
<body>
	...
	<div class="container">
		...
		Uw bestelling voor beursmateriaal met nummer {{ $order->id }} staat klaar voor verzending. <br><br>
		...
		<br><br>
		Voor meer informatie over deze bestelling, <a href="http://portal.dev/beursmateriaal/detail/{{$order->id}}">klik hier</a>.
		<br><br>
		<hr>
		<br><br>
		Chèr Collègues de Konvert {{ $order->user->name }}, <br><br>
		Votre commande de matériel de salon avec numéro de commande {{ $order->id }} est prête à être livrée.<br><br>
		...
		@endif
		<br><br>
		Pour plus d’informations, <a href="http://portal.dev/beursmateriaal/detail/{{$order->id}}">cliquez ici</a>.
		<br><br>
