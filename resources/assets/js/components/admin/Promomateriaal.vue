<template>
	...
	<hero title="Overzicht Promomateriaal" :hasSubtitle="false" type="is-blue"></hero>
	<notification></notification>
		<div class="modal editModal">
			...
			<div class="modal-content">
				<div class="content">
					...
					<div class="form-input">
						<label class="label">Prijs (x1000)</label>
						<p class="control">
							<input class="input" type="text" placeholder="Prijs" v-model="productToEdit.price">
						</p>
					</div>
					<div class="form-input">
							<p class="control">
		...
		<div class="container">
			<section class="section">
				<!-- <h3 class="title is-title-centered-message">Promomateriaal</h3> -->
				<ul class="cart-list">
					<li v-for="item in promomateriaal" class="slideInLeft">
						<div class="cart-item-segment">
							...
							<div class="cart-item-controls">
								...
								<a class="button button-round is-primary transitioning-icon" data-lity :data-lity-target="'/images/promomateriaal/'+item.image+'.png'">
									<span class="icon is-small has-stacked-icons has-animation">
										<i class="fa fa-eye"></i>
										<i class="fa fa-eye"></i>
									</span>
